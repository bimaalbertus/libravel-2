    ...
    @switch($type)
        ...
        @case('icon')
            <div x-data="{ open: false }">
                <span @click="open= !open"
                    class="inline-flex items-center justify-center p-2 bg-black dark:bg-white rounded-xl text-black dark:text-white bg-opacity-0 hover:bg-opacity-10 dark:bg-opacity-0 dark:hover:bg-opacity-10 transition ease-linear cursor-pointer">
                    <svg x-show="theme === 'system'" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                    ...
                    <svg x-show="theme ==='light'" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <svg x-show="theme === 'dark'" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                    </svg>
                ...
                <div x-show="open" x-cloak x-on:click.away="open = false"
                    ...
                    <div
                        ...
                        <span @click.prevent="setTheme('light')"
                            class="inline-flex items-center gap-2 p-1.5 rounded-md cursor-pointer hover:bg-dark-bg/10 dark:hover:bg-light-bg/10">
                            <p>Light</p>
                        </span>
                        <span @click.prevent="setTheme('dark')"
                            class="inline-flex items-center gap-2 p-1.5 rounded-md cursor-pointer hover:bg-dark-bg/10 dark:hover:bg-light-bg/10">
        ...
        @default
            <button class="flex items-center gap-1 bg-transparent border border-black/20 dark:border-white/20 rounded-full">
                <span @click.prevent="setTheme('system')"
                    :class="{ 'bg-black text-white dark:bg-white dark:text-black scale-110': theme === 'system' }"
                ...
                <span @click.prevent="setTheme('light')"
                    :class="{ 'bg-black text-white dark:bg-white dark:text-black scale-110': theme === 'light' }"
                    class="p-1.5 rounded-full transition duration-200">
                ...
                <span @click.prevent="setTheme('dark')"
                    :class="{ 'bg-black text-white dark:bg-white dark:text-black scale-110': theme === 'dark' }"
                    class="p-1.5 rounded-full transition duration-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-[1.15rem]" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
